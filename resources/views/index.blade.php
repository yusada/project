...
<body>
    <section class="w-full flex justify-center absolute h-20 z-10">
    ...
    <section class="w-full flex justify-center relative min-h-screen">
        ...
        <div class="w-11/12 flex justify-between relative items-center">
            <div>
                ...
                <p class="text-white text-[18px]">by using Deep Learning, dental caries can be identified the type of
                    caries you have</p>
    ...
    <section class="w-full flex justify-center">
        <div class="w-11/12">
            ...
            <p class="text-sky-400 text-[20px]">Dental Caries. tooth decay, also known as dental caries, is a dental and
                oral health condition that can allect anyone.
